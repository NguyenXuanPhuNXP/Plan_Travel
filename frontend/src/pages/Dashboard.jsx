...
import { Calendar, MapPin, ArrowRight, Plus, Map as MapIcon, ChevronRight } from 'lucide-react';
    ...
    <Layout>
      ...
      >
        ...
        <motion.div variants={item} className="dashboard-stats-grid">
          <div className="card dashboard-card-primary">
            <h3 className="dashboard-card-title">Lập kế hoạch mới</h3>
            <p className="dashboard-card-desc">Khám phá các điểm đến và tạo lịch trình chi tiết.</p>
            <Link to="/planner" className="btn dashboard-card-btn">
          ...
          <div className="card">
            ...
            <div className="dashboard-stat-sub">+2 trong tháng này</div>
          </div>

          <div className="card">
            <div className="dashboard-stat-header">
              <span className="dashboard-stat-label">ĐIỂM ĐẾN SẮP TỚI</span>
              <div className="dashboard-stat-icon-wrapper-2">
                <MapPin size={20} />
              </div>
            </div>
            <div className="dashboard-stat-value-sm">
              {trips.find(t => t.status === 'upcoming')?.title || 'Chưa có kế hoạch'}
            </div>

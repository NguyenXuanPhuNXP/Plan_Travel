...
const AdminPlaceCreate = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setErrorMessage(error.response?.data?.message || 'Không thể tạo location.');
    } finally {
      setSaving(false);
    }
  };
    ...
    <AdminLayout>
      <div className="admin-container">
        <div className="admin-header">
          <div>
            <h1 className="admin-title">Thêm địa điểm</h1>
            <p className="admin-subtitle">Tạo location mới.</p>
          </div>
